					...
					<div class="kt-widget__wrapper">
						...
						<div class="kt-widget__stats">
							<div class="kt-widget__stat" href="#">
								<span class="kt-widget__value">01/11/2019</span>
								<span class="kt-widget__caption">Última inspección</span>
							</div>
							<div class="kt-widget__stat" href="#">
								<span class="kt-widget__value">15/12/2019</span>
					...
					<ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-clear nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand kt-portlet__space-x" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#kt_apps_user_edit_tab_1" role="tab">
								<i class="flaticon2-calendar-3"></i> Información de tractor
							</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#kt_apps_user_edit_tab_4" role="tab">
								<i class="flaticon2-gear"></i> Configuración
							</a>
						</li>
					</ul>
				</div>
