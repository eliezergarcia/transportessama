					...
					<table class="table table-head-noborder" id="boxesTable">
						...
						<tbody>
							<tr v-for="box in boxes">
								...
								<td>@{{ dateMileage(box.date_mileage) }}</td>
								<td>
									<div v-if="box.inactive_at">
										<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded">Desactivado</span>
									</div>
									<div v-if="box.inactive_at === null" style="display:flex;flex-direction:column;">
										<div v-if="box.status_mileage === 1">
										...
										<div v-if="box.status_mileage === 2">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: #fbc02d;"></span>
										</div>
										<div v-if="box.status_mileage === 3">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: #d32f2f;"></span>
										</div>
										<div v-if="box.status_mileage === 0">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: gray;"></span>
										</div>
										<div v-if="box.status_mileage === null">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: transparent;"></span>
										</div>
										<div v-if="box.status_parts === 1">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: #388e3c;"></span>
										</div>
										<div v-if="box.status_parts === 2">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: #fbc02d;"></span>
										</div>
										<div v-if="box.status_parts === 3">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: #d32f2f;"></span>
										</div>
										<div v-if="box.status_parts === 0">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: gray;"></span>
										</div>
										<div v-if="box.status_parts === null">
											<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
												style="width: 75px;height:4px;padding:0;background: transparent;"></span>
										</div>
									</div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Crear caja</h5>
	...
	<script type="text/javascript">
		var app = new Vue({
			...
			methods: {
				truckStatus(box = []){
					let me = this;
		  			axios.get(this.base_url + '/cajas/status/' + box.id)
			      	.then(response => {
		  		...
		  		createTruck() {
					...
					axios.post(this.base_url + '/cajas', {
				  	...
				  	.then(function (response) {
						...
						toastr.success("El caja se registró correctamente.", "Correcto");
					})
				...
				showEditModal(box = []) {
					...
					this.vin = box['vin'];
					this.latest_mileage = box['latest_mileage'];
					this.actual_mileage = box['actual_mileage'];
					this.date_mileage = box['date_mileage'];
				...
				deactivateTruck() {
					...
					axios.post(this.base_url + '/cajas/desactivar/' + this.id_box, {
				  	...
				  	.then(function (response) {
						...
						toastr.success("El caja se desactivó correctamente.", "Correcto");
					})
					.catch(function (error) {
					    console.log(error);
					    me.closeDeactivateModal();
				...
				activateTruck() {
					...
					axios.post(this.base_url + '/cajas/activar/' + this.id_box, {
				  	...
				  	.then(function (response) {
						...
						toastr.success("El caja se activó correctamente.", "Correcto");
					})
					.catch(function (error) {
					    console.log(error);
					    me.closeActivateModal();
