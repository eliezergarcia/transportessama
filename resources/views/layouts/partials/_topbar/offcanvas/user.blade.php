			...
			<div class="kt-user-card-v3__detalis">
				...
				<div class="kt-user-card-v3__info">
					...
					<a href="{{ route('usuarios.edit',  Auth::user()->id) }}">
						<button type="button" class="btn btn-outline-hover-info">
							<i class="la la-user"></i> Ver perfil
						</button>
					</a>
					<!-- <a href="#" class="kt-user-card-v3__item">
			...
			<div class="kt-widget-4__items">
				...
				<div class="kt-widget-4__item">
					<div class="kt-widget-4__item-content">
						<div class="kt-widget-4__item-section">
							<div class="kt-widget-4__item-pic">
								<img class="" src="assets/media/product-logos/logo2.png" alt="">
							</div>
							<div class="kt-widget-4__item-info">
								<a href="#">
				...
				<div class="kt-widget-4__item">
					<div class="kt-widget-4__item-content">
						<div class="kt-widget-4__item-section">
							<div class="kt-widget-4__item-pic">
								<img class="" src="assets/media/product-logos/logo3.png" alt="">
							</div>
							<div class="kt-widget-4__item-info">
								<a href="#">
