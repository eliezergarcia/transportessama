		...
		<div class="kt-container  kt-container--fluid ">
			...
			<div class="kt-subheader__toolbar">
				<div class="kt-subheader__toolbar-wrapper">
					...
					<button type="button" class="btn btn-brand btn-md btn-bold btn-upper" @click="showEditModal(box)">Editar caja</button>
					...
					<div class="kt-widget__wrapper">
						...
						<div class="kt-widget__links">
							<div class="kt-widget__cont">
								...
								<div class="kt-widget__link">
									<span>Vin: </span><a href="#">&nbsp;{{ $box->vin }}</a>
								</div>
							</div>
						</div>
						<div class="kt-widget__links">
							<div class="kt-widget__cont">
								<div class="kt-widget__link">
									<span>Kilometraje última inspección: </span><a href="#">&nbsp;{{ $box->latest_mileage }}</a>
								</div>
								<div class="kt-widget__link">
									<span>Kilometraje actual: </span><a href="#">&nbsp;{{ $box->actual_mileage }}</a>
								</div>
								<div class="kt-widget__link">
									<span>Fecha de kilometraje: </span><a href="#">&nbsp;{{ $box->getLatestMileageInspection() }}</a>
								</div>
							</div>
						</div>
						<div class="kt-widget__links">
							<div class="kt-widget__cont">
								...
								<div class="kt-widget__link">
									...
									@if($box->status_parts === 1) 
										...
										style="width: 75px;height:4px;padding:0;background: #388e3c;"></span>
									@endif
									@if($box->status_parts === 2) 
										<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
										style="width: 75px;height:4px;padding:0;background: #fbc02d;"></span>
									@endif
									@if($box->status_parts === 3) 
										<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
										style="width: 75px;height:4px;padding:0;background: #d32f2f;"></span>
									@endif
									@if($box->status_parts === 0) 
										<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
										style="width: 75px;height:4px;padding:0;background: gray;"></span>
									@endif
									@if($box->status_parts === null) 
										<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--rounded"
										style="width: 75px;height:4px;padding:0;background: transparent;"></span>
									@endif
								</div>
						...
						<div class="kt-widget__stats">
							<div class="kt-widget__stat" href="#">
								<span class="kt-widget__value">{{ $box->ultimaInspeccion() }}</span>
...
@section('modals')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Agregar parte de caja</h5>
	...
	<div class="modal fade" id="editPartModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="mediumModalLabel">Editar parte de caja</h5>
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-body">
				<div class="py-3 text-center">
					...
					<p>
						Estás a punto de desactivar esta parte del caja
					</p>
				</div>
    ...
    <div class="modal fade" id="createSubpartModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Agregar subparte de caja</h5>
	...
	<div class="modal fade" id="editSubpartModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Editar subparte de caja</h5>
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-body">
				<div class="py-3 text-center">
					...
					<h4 class="heading mt-4">Estás seguro?</h4>
					<p>
						Estás a punto de desactivar esta subparte de la caja
					</p>
				</div>
				<input type="hidden" v-model="id_part">
				<input type="hidden" v-model="method_field" name="_method" value="DELETE">
    ...
    <!-- Modal Editar Información de Caja -->
    <div class="modal fade" id="editTruckModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mediumModalLabel">Editar información de caja</h5>
                    <button type="button" class="close" @click="closeEditModal()" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
					<form method="POST" action="{{ route('tractores.update', $box->id) }}" enctype="multipart/form-data" class="pl-2 pr-2">
						{!! csrf_field() !!}
						{!! method_field('PUT') !!}
						<input type="hidden" id="id_box" name="id_box" value="{{ $box->id }}">
						<div class="form-group row">
							<div class="col-lg-3">
								<label for="trailer" class=" form-control-label">Trailer:</label>
								<input type="text" value="{{ $box->trailer }}" id="trailer" name="trailer" class="form-control">
							...
							<div class="col-lg-3">
								...
								<select class="form-control" name="type" id="type">
									<option value="Transfer" @if($box->type === "Transfer") selected='selected' @endif >Transfer</option>
									<option value="Foráneo" @if($box->type === "Foráneo") selected='selected' @endif>Foráneo</option>
							...
							<div class="col-lg-3">
								...
								<input type="text" value="{{ $box->plates }}" id="plates" name="plates" class="form-control">
								<span class="form-text text-muted">Porfavor ingresa las placas</span>
							</div>
							<div class="col-lg-3">
								<label for="vin" class=" form-control-label">Vin:</label>
								<input type="text" value="{{ $box->vin }}" id="vin" name="vin" class="form-control">
						...
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<input type="number" value="{{ $box->latest_mileage }}" id="latest_mileage" name="latest_mileage" class="form-control">
							...
							<div class="col-lg-4">
								...
								<input type="number" value="{{ $box->actual_mileage }}" id="actual_mileage" name="actual_mileage" class="form-control">
							...
							<div class="col-lg-4">
								...
								<input type="date" value="{{ $box->date_mileage }}" id="date_mileage" name="date_mileage" class="form-control">
    ...
    <!-- Fin de Modal Editar Información de Caja -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="py-3 text-center">
                ...
                <h4 class="heading mt-4">Estás seguro?</h4>
                <p>
                    Estás a punto de activar este caja
                </p>
            </div>
    ...
    <!-- Fin del Modal Activar Caja -->

	<!-- Modal Desactivar Caja -->
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="py-3 text-center">
                ...
                <h4 class="heading mt-4">Estás seguro?</h4>
                <p>
                    Estás a punto de desactivar este caja
                </p>
            </div>
            <input type="hidden" v-model="id_box">
            <input type="hidden" v-model="method_field" name="_method" value="DELETE">
		...
		methods: {
			...
			getParts(){
				...
				datatable = $('#partsTableChild').KTDatatable({
					...
					data: {
						...
						source: {
							read: {
								url: this.base_url + '/partes/obtenerPartesCaja/' + document.getElementById('id_box').value,
								method: 'GET'
							},
						},
					...
					columns: [
						...
						},
						{
							...
							template: function (row, data, index) {
								...
								return "<a onclick='showEditPartModal("+data+")' class='btn btn-sm btn-clean btn-icon btn-icon-sm' data-toggle='tooltip' data-placement='top' title='' data-original-title='Ver detalles'><i class='flaticon-edit-1'></i></a>\
										<a onclick='showDeactivatePartModal("+data+")' class='btn btn-sm btn-icon btn-clean btn-icon-sm' data-toggle='tooltip' data-placement='top' title='' data-original-title='Ver detalles'><i class='flaticon-delete-1'></i></a>";
							},
						}],
				});
			...
			saveTruck() {
				...
				.then(function (response) {
					...
					toastr.success("La información del caja se guardó correctamente.", "Correcto");
			...
			createPart(){
				...
				.then(function (response) {
					...
					toastr.success("La parte se agregó al caja correctamente.", "Correcto");
					window.location.reload()
				})
				.catch(function (error) {
					console.log(error);
			...
			createSubpart(){
				...
				.then(function (response) {
					...
					toastr.success("La subparte se agregó a la caja correctamente.", "Correcto");
					window.location.reload()
				})
				.catch(function (error) {
					console.log(error);
